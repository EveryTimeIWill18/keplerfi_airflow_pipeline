...
#################################################################################################################
variable_class_builder.create_new_variable(var_name='one_day_diff',
                                           data_source='Shardar',
                                           ...
                                           query_logic="""select a.date, a.ticker,  a.close/b.close-1 as value
                                                          ...
                                                          left outer join
                                                            (select ticker, date, close from will_airflow_db.price_data
                                                          where ticker = 'FB' and
                                                            date = DATE_SUB('<DATEID>', INTERVAL 1 DAY)) b
...
# print(variable_class_builder.variable_abstractions['one_day_diff_partition'].__dict__['query_logic'])
